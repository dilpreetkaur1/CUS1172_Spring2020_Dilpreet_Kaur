...
var choices;
$.ajax({
    url: "http://dilpreet-kaur-quiz-milestone-2.herokuapp.com/quiz1/api/quiz/list",
...
if(q_meta != -1){
    ...
    $.ajax({
        ...
        url: "http://dilpreet-kaur-quiz-milestone-2.herokuapp.com/quiz1/api/quiz?id="+quiz_choice+"&questionid="+q_id,
...
function quiz1Submit() {
    ...
    if (quiz1_res[quiz1_array_count].type == "checkboxes") {
       ...
       url="http://dilpreet-kaur-quiz-milestone-2.herokuapp.com/quiz1/api/quiz_ans?id="+quiz_choice+"&questionid="+q_id+"&user_ans="+chkbox_ans_arr
    }else{
       url= "http://dilpreet-kaur-quiz-milestone-2.herokuapp.com/quiz1/api/quiz_ans?id="+quiz_choice+"&questionid="+q_id+"&user_ans="+quiz1_current_user_ans
    }
...
function openQuiz(evt, quizName) {
    ...
    if (quizName == "quiz1") {
        if (showQuiz_count == 0) {
            // showQuiz1();
            quiz_choice = choices[0].quiz1;

            // /:"+quiz_choice

            $.ajax({
                url: `http://dilpreet-kaur-quiz-milestone-2.herokuapp.com/quiz1/api/quiz/${quiz_choice}`,
                method: "get",
                contentType: "json/application",
                dataType: 'json',
                success: function (response) {
        ...
        window.location.href = "quiz_milestone2.html"
        // showQuiz2();
    }
